...
var clarifaiApp = new Clarifai.App({
  apiKey: '7bbcb8bc488240c8a1e0266d3956ad26',
});
/*
...
var predictImage = function (imageUrl) {
  if (clarifaiApp._config.apiKey === '7bbcb8bc488240c8a1e0266d3956ad26') {
    throw new Error(
      'You must add your API key before you can predict an image'
    );
  }
